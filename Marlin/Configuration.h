...
#define CONFIG_EXAMPLES_DIR "Creality/Ender-5/BigTreeTech SKR Mini E3 3.0"
...
#define STRING_CONFIG_H_AUTHOR "(Seelenkind, Ender-5-SKR-mini-E3-V3.0)" // Who made the changes.
